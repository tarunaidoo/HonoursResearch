...
def generate_and_save_mazes_json():
    ...
    #     ((5, 5), 0.1, 5),
    #     ((5, 5), 0.3, 5),
    #     ((5, 5), 0.5, 5),  # New high-density mazes
    #     ((10, 10), 0.1, 5),
    #     ((10, 10), 0.2, 5),
    #     ((10, 10), 0.3, 5),
    #     ((10, 10), 0.5, 5),  # New high-density mazes
    #     ((20, 20), 0.1, 5),
    #     ((20, 20), 0.2, 5),
    #     ((20, 20), 0.3, 5),
    #     ((20, 20), 0.5, 5),  # New high-density mazes
    #     ((40, 40), 0.1, 5),
    #     ((40, 40), 0.2, 5),
    #     ((40, 40), 0.3, 5),
    #     ((40, 40), 0.5, 5),  # New high-density mazes
    #     ((80, 80), 0.1, 5),
    #     ((80, 80), 0.2, 5),
    #     ((80, 80), 0.3, 5),
    #     ((80, 80), 0.5, 5),  # New high-density mazes
    #     ((160, 160), 0.1, 5),
    #     ((160, 160), 0.2, 5),
    #     ((160, 160), 0.3, 5),
    #     ((160, 160), 0.5, 5), # New high-density mazes
    #     ((320, 320), 0.1, 5),
    #     ((320, 320), 0.2, 5),
    #     ((320, 320), 0.3, 5),
    #     ((320, 320), 0.5, 5), # New high-density mazes
    #     ((640, 640), 0.1, 5),
    #     ((640, 640), 0.2, 5),
    #     ((640, 640), 0.3, 5),
    #     ((640, 640), 0.5, 5), # New high-density mazes
    #     ((1024, 1024), 0.1, 5),
    #     ((1024, 1024), 0.2, 5),
    #     ((1024, 1024), 0.3, 5),
    #     ((1024, 1024), 0.5, 5), # New high-density mazes
    #     ((2048, 2048), 0.1, 5),
    #     ((2048, 2048), 0.3, 5),
    #     ((2048, 2048), 0.5, 5),
    # ]
